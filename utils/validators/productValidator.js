...
exports.createProductValidator = [
    ...
    check('sold')
        .optional()
        .isInt({ min: 0 })
        .withMessage('Product sold must be an integer greater than or equal to 0'),
    check('imageCover')
        .notEmpty()
    ...
    check('images')
        .optional()
        .isArray()
        .withMessage('Product images must be an array of image names'),
    check('category')
        .notEmpty()
...
exports.getProductsValidator = [
    ...
    check('sortBy')
        .optional()
        .isIn(['title', 'price', 'ratingsAverage', 'sold', 'quantity', 'createdAt', 'updatedAt'])
        .withMessage('sortBy must be one of: title, price, ratingsAverage, sold, quantity, createdAt, updatedAt'),
    check('order')
        .optional()
        .isIn(['asc', 'desc'])
    ...
    check('sortPreset')
        .optional()
        .isIn(['newest', 'oldest', 'price_asc', 'price_desc', 'rating_desc', 'best_selling', 'title_asc', 'title_desc'])
